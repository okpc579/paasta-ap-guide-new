...
> $ vi ~/workspace/paasta-5.5.2/deployment/service-deployment/glusterfs/vars.yml
...
> $ vi ~/workspace/paasta-5.5.2/deployment/service-deployment/glusterfs/deploy.sh
...
- 서비스를 설치한다.  
```
$ cd ~/workspace/paasta-5.5.2/deployment/service-deployment/glusterfs  
$ sh ./deploy.sh  
```  
...
- 서비스 설치에 필요한 릴리즈 파일을 다운로드 받아 Local machine의 서비스 설치 작업 경로로 위치시킨다.  
  ...
  - 설치 릴리즈 파일 다운로드 : [paasta-glusterfs-2.1.0.tgz](https://nextcloud.paas-ta.org/index.php/s/bkz8asGEz5Swz45/download)
